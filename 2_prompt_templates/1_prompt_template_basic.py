...
system_message_template = SystemMessagePromptTemplate.from_template(
    "You are a helpful AI assistant named {name}. Your goal is to provide concise and accurate information."
)
chat_template = ChatPromptTemplate.from_messages([
        system_message_template,
        ("human", "Tell me about {topic}.")
    ])
formatted_prompt = chat_template.invoke({"name": "LangChainBot", "topic": "AI development"})
